    ...
    return (
        <>
            ...
            <section id='sobre' className='flex font column'>
                ...
                <div id='txtSobre'>
                    <h1><span>SOBRE</span> <span>NÓS</span></h1>
                ...
                <div id='imgSobre'>
                    <img data-aos="fade-right" data-aos-duration="1000" data-aos-mirror="true" className='lixoDesktop' src={Lixo1} alt="imagem lixo" />
                    <img data-aos="fade-left" data-aos-duration="1000" data-aos-mirror="true" className='lixoDesktop' src={Lixo2} alt="imagem lixo" />
                    <img data-aos="fade-right" data-aos-duration="1000" data-aos-mirror="true" className='lixoDesktop' src={Lixo3} alt="imagem lixo" />
                </div>
